...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    pricing: 'From $14/mo',
    bestFor: 'Growing WordPress websites and agency hosting',
  ...
  },
  {
    ...
    hasApi: false,
    wpIntegration: true,
    testingPeriod: '6 months while beta testing on random sites',
  ...
  },
  {
    ...
    bestFor: 'Agencies, professional web designers, and developers building high-performance websites',
    pricingModel: 'One-time / Lifetime License',
    hasFreePlan: false,
    hasApi: true,
    wpIntegration: true,
    testingPeriod: '90 days while beta testing on random sites',
